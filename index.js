...
/*
The nested function is able to reach outside of its scope to get the value of the variable internal; this is an example of lexical scope.
...
const zooAnimals = [
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const lowPopArray = array.filter((item) => {
  ...
  */
  ...
  function USApop(array){
    const totalPopArray = array.reduce((total, item) => {
